...
After compiling and building the project with the `mvn` command, it can be found a report with the coverage of the unit tests generated by jacoco-maven-plugin under `\target\site\jacoco\index.html`
